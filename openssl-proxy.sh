...
generate_root_certs() {
    ...
    [req]
    prompt=no
    distinguished_name = Playreact
    x509_extensions = Playreact_extensions

    [ Playreact ]
    organizationName = Playreact
    commonName = Root CA for Playreact

    [ Playreact_extensions ]
...
generate_node_certs() {
    ...
    [ req ]
    prompt=no
    distinguished_name = Playreact_Node
